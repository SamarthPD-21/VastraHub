        ...
        <div className="fixed inset-0 z-[var(--z-modal)] flex items-end justify-center p-4 sm:items-center sm:p-6">
          ...
          >
            ...
            <div className="p-8 text-center mt-2">
              ...
              <h2 className="text-2xl font-black italic tracking-tight" style={{ fontFamily: 'var(--font-heading)', color: 'var(--color-text)' }}>
                SPECIAL OFFER!
              </h2>
              ...
              <div className="mt-8 flex flex-col gap-3">
                ...
                >
                  <span className="text-xl font-black tracking-widest" style={{ color: 'var(--color-text)' }}>
                    {COUPON_CODE}
                  </span>
                  <button
                    onClick={handleCopy}
