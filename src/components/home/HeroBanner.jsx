        ...
        <AnimatePresence mode="wait">
          ...
          >
            <h1
              ...
              style={{ fontFamily: 'var(--font-heading)', textShadow: '0 2px 12px rgba(0,0,0,0.4)' }}
            >
              {slide.heading}
            </h1>
            <p className="max-w-lg text-sm text-white/85 md:text-base" style={{ textShadow: '0 1px 6px rgba(0,0,0,0.4)' }}>
              {slide.subheading}
            </p>
            <Link
              to={slide.ctaLink}
              className="mt-2 inline-flex w-fit items-center rounded-full px-7 py-3 text-sm font-semibold text-white shadow-lg transition-transform hover:scale-105 hover:opacity-90"
