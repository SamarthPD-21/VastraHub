...
export default function ProductCard({ product }) {
  ...
  return (
    <article
      className="group relative flex flex-col overflow-hidden rounded-2xl transition-shadow hover:shadow-xl"
    ...
    >
      ...
      <div className="flex flex-col gap-1 p-3">
        <Link
          to={`/product/${product.id}`}
          className="line-clamp-2 text-sm font-semibold leading-snug hover:text-[color:var(--color-primary)] transition-colors"
